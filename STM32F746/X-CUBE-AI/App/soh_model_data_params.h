...
#define AI_SOH_MODEL_DATA_ACTIVATIONS_SIZES \
  { 2392, }
#define AI_SOH_MODEL_DATA_ACTIVATIONS_SIZE     (2392)
#define AI_SOH_MODEL_DATA_ACTIVATIONS_COUNT    (1)
#define AI_SOH_MODEL_DATA_ACTIVATION_1_SIZE    (2392)



#define AI_SOH_MODEL_DATA_WEIGHTS_SIZES \
  { 18020, }
#define AI_SOH_MODEL_DATA_WEIGHTS_SIZE         (18020)
#define AI_SOH_MODEL_DATA_WEIGHTS_COUNT        (1)
#define AI_SOH_MODEL_DATA_WEIGHT_1_SIZE        (18020)
