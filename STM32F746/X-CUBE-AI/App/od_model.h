/**
  ...
  ******************************************************************************
  */
#ifndef AI_OD_MODEL_H
#define AI_OD_MODEL_H

#include "od_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_OD_MODEL_MODEL_NAME          "od_model"
#define AI_OD_MODEL_ORIGIN_MODEL_NAME   "cat_ultimate_final"

/******************************************************************************/
#define AI_OD_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_OD_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_OD_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_OD_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_OD_MODEL_IN \
  ai_od_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_OD_MODEL_IN_SIZE { \
  AI_OD_MODEL_IN_1_SIZE, \
}
#define AI_OD_MODEL_IN_SIZE_BYTES { \
  AI_OD_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_OD_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_OD_MODEL_IN_1_HEIGHT      (128)
#define AI_OD_MODEL_IN_1_WIDTH       (128)
#define AI_OD_MODEL_IN_1_CHANNEL     (3)
#define AI_OD_MODEL_IN_1_SIZE        (49152)
#define AI_OD_MODEL_IN_1_SIZE_BYTES  (49153)

/******************************************************************************/
#define AI_OD_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_OD_MODEL_OUT \
  ai_od_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_OD_MODEL_OUT_SIZE { \
  AI_OD_MODEL_OUT_1_SIZE, \
}
#define AI_OD_MODEL_OUT_SIZE_BYTES { \
  AI_OD_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_OD_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_OD_MODEL_OUT_1_CHANNEL     (5)
#define AI_OD_MODEL_OUT_1_SIZE        (5)
#define AI_OD_MODEL_OUT_1_SIZE_BYTES  (5)

/******************************************************************************/
#define AI_OD_MODEL_N_NODES (67)
 ...
 * @ref ai_od_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_od_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_od_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_od_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_OD_MODEL_*
 * defines into file @ref od_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
